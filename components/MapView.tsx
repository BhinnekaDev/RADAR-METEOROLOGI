...
const AIRPORT_LOCATIONS = [
    ...
    { name: "Cut Nyak Dhien", code: "MEQ", lat: 4.25, lon: 96.217 },
    {
        name: "Maimun Saleh",
        code: "SBG",
        lat: 5.873611,
    ...
    { name: "Tanah Merah", code: "TMH", lat: -6.1, lon: 140.3 },
    {
        name: "Mozes Kilangin",
        code: "TIM",
        lat: -4.528278,
    ...
    { name: "Wamena", code: "WMX", lat: -4.096667, lon: 138.95 },
    { name: "Babo", code: "BXB", lat: -2.533889, lon: 133.4 },
    {
        name: "Domine Eduard Osok",
        code: "SOQ",
        lat: -0.925833,
    ...
    { name: "Siboru", code: "SBV", lat: -2.530556, lon: 133.3975 },
    { name: "Enggano", code: "EGN", lat: -5.401944, lon: 102.265833 },
    { name: "Muko-Muko", code: "MPC", lat: -2.533889, lon: 101.093056 },
    {
    ...
    { name: "Rembele", code: "TXE", lat: 4.132778, lon: 96.131111 },
    { name: "Komodo", code: "LBJ", lat: -8.486111, lon: 119.888611 },
];
